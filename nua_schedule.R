...
#Load Data
#incident <- read.csv("~/Desktop/NewOrleans-master-80ea90a6f4b0dbc93132a0d886ba6398c8992632/Data/2016_11_Incidents.csv")
incident <- read.csv("~/Desktop/NewOrleans-master-80ea90a6f4b0dbc93132a0d886ba6398c8992632/Data/all_Incidents.csv")
...
#Testing different functions to get Erlag B before I write the function
erlb(5, 4.05)
elf(5, 4.05)
...
nua_schedule <- function(x, c, y, d, z, e) {
    ...
    gp2$NUA_Probability <- as.data.frame(ErlagB)
    
    return(as.data.frame(gp2))
    }


#Save the Ouput of the Function 
Schedule_For_Tuesday <- nua_schedule(incident, 25, 11, "Wednesday", 0, 4)

Schedule_For_Tuesday$NUA_Probability
